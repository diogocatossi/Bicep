...
@minLength(2)
@maxLength(10)
param parSubscriptionPrefix string = 'alz'
...
var varDeploymentNameWrappers = {
  ...
  baseSuffixTenantAndManagementGroup: '${deployment().location}-${uniqueString(deployment().location, parSubscriptionPrefix)}'
}
...
var varPolicyAssignmentDenyDataBPip = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_databricks_public_ip.tmpl.json'))
}
...
var varPolicyAssignmentDenyDataBSku = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_databricks_sku.tmpl.json'))
}
...
var varPolicyAssignmentDenyDataBVnet = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_databricks_vnet.tmpl.json'))
}
...
var varPolicyAssignmentEnforceAksHttps = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_http_ingress_aks.tmpl.json'))
}
...
var varPolicyAssignmentDenyIpForwarding = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_ip_forwarding.tmpl.json'))
}
...
var varPolicyAssignmentDenyPrivContainersAks = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_priv_containers_aks.tmpl.json'))
}
...
var varPolicyAssignmentDenyPrivEscalationAks = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_priv_escalation_aks.tmpl.json'))
}
...
var varPolicyAssignmentDenyPublicEndpoints = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_public_endpoints.tmpl.json'))
}
...
var varPolicyAssignmentDenyPublicIp = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_public_ip.tmpl.json'))
}
...
var varPolicyAssignmentDenyRdpFromInternet = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_rdp_from_internet.tmpl.json'))
}
...
var varPolicyAssignmentDenyStorageHttp = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_storage_http.tmpl.json'))
}
...
var varPolicyAssignmentDenySubnetWithoutNsg = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deny_subnet_without_nsg.tmpl.json'))
}
...
var varPolicyAssignmentDeployAksPolicy = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_aks_policy.tmpl.json'))
}
...
var varPolicyAssignmentDeployAscMonitoring = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_asc_monitoring.tmpl.json'))
}
...
var varPolicyAssignmentDeployAzActivityLog = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_azactivity_log.tmpl.json'))
}
...
var varPolicyAssignmentDeployLogAnalytics = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_log_analytics.tmpl.json'))
}
...
var varPolicyAssignmentDeployMdfcConfig = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_mdfc_config.tmpl.json'))
}
...
var varPolicyAssignmentDeployResourceDiag = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_resource_diag.tmpl.json'))
}
...
var varPolicyAssignmentDeploySqlDbAuditing = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_sql_db_auditing.tmpl.json'))
}
...
var varPolicyAssignmentDeploySqlThreat = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_sql_threat.tmpl.json'))
}
...
var varPolicyAssignmentDeployVmBackup = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_vm_backup.tmpl.json'))
}
...
var varPolicyAssignmentDeployVmMonitoring = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_vm_monitoring.tmpl.json'))
}
...
var varPolicyAssignmentDeployVmssMonitoring = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_deploy_vmss_monitoring.tmpl.json'))
}
...
var varPolicyAssignmentEnableDdosVnet = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_enable_ddos_vnet.tmpl.json'))
}
...
var varPolicyAssignmentEnforceTlsSsl = {
	...
	libDefinition: json(loadTextContent('../../../policySubscription/assignments/lib/policy_assignments/policy_assignment_es_enforce_tls_ssl.tmpl.json'))
}
...
var varSubscriptionIds = {
  intRoot             : parSubscriptionPrefix
  platform            : '${parSubscriptionPrefix}-platform'
  platformManagement  : '${parSubscriptionPrefix}-platform-management'
  platformConnectivity: '${parSubscriptionPrefix}-platform-connectivity'
  platformIdentity    : '${parSubscriptionPrefix}-platform-identity'
  landingZones        : '${parSubscriptionPrefix}-landingzones'
  landingZonesCorp    : '${parSubscriptionPrefix}-landingzones-corp'
  landingZonesOnline  : '${parSubscriptionPrefix}-landingzones-online'
  decommissioned      : '${parSubscriptionPrefix}-decommissioned'
  sandbox             : '${parSubscriptionPrefix}-sandbox'
}

var varTopLevelManagementGroupResourceId = '/providers/Microsoft.Management/managementGroups/${varSubscriptionIds.intRoot}'
...
module modPolicyAssignmentIntRootDeployMdfcConfig '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.intRoot)
...
module modPolicyAssignmentIntRootDeployAzActivityLog '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.intRoot)
...
module modPolicyAssignmentIntRootDeployAscMonitoring '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  // dependsOn: [
...
module modPolicyAssignmentIntRootDeployResourceDiag '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.intRoot)
...
module modPolicyAssignmentIntRootDeployVmMonitoring '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.intRoot)
...
module modPolicyAssignmentIntRootDeployVmssMonitoring '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.intRoot)
...
module modPolicyAssignmentConnEnableDdosVnet '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = if (!empty(parDdosProtectionPlanId)) {
  scope: subscription(varSubscriptionIds.platformConnectivity)
...
module modPolicyAssignmentIdentDenyPublicIp '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.platformIdentity)
...
module modPolicyAssignmentIdentDenyRdpFromInternet '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.platformIdentity)
...
module modPolicyAssignmentIdentDenySubnetWithoutNsg '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.platformIdentity)
...
module modPolicyAssignmentIdentDeployVmBackup '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.platformIdentity)
...
module modPolicyAssignmentMgmtDeployLogAnalytics '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.platformManagement)
...
module modPolicyAssignmentLzsDenyIpForwarding '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
// Module - Policy Assignment - Deny-RDP-From-Internet
module modPolicyAssignmentLzsDenyRdpFromInternet '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
// Module - Policy Assignment - Deny-Subnet-Without-Nsg
module modPolicyAssignmentLzsDenySubnetWithoutNsg '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
// Module - Policy Assignment - Deploy-VM-Backup
module modPolicyAssignmentLzsDeployVmBackup '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
// Module - Policy Assignment - Enable-DDoS-VNET
module modPolicyAssignmentLzsEnableDdosVnet '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = if (!empty(parDdosProtectionPlanId)) {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDenyStorageHttp '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDeployAksPolicy '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDenyPrivEscalationAks '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDenyPrivContainersAks '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsEnforceAksHttps '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsEnforceTlsSsl '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDeploySqlDbAuditing '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDeploySqlThreat '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZones)
...
module modPolicyAssignmentLzsDenyPublicEndpoints '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZonesCorp)
...
// Module - Policy Assignment - Deny-Public-IP
module modPolicyAssignmentLzsDenyPublicIp '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZonesCorp)
...
module modPolicyAssignmentLzsDenyDataBPip '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZonesCorp)
...
module modPolicyAssignmentLzsDenyDataBSku '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZonesCorp)
...
module modPolicyAssignmentLzsDenyDataBVnet '../../../policySubscription/assignments/policyAssignmentManagementGroup.bicep' = {
  scope: subscription(varSubscriptionIds.landingZonesCorp)
